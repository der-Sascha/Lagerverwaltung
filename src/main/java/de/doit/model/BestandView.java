...
public class BestandView {
    ...
    // nur für ein Zwischenergebnis abzubilden: "wie viel liegt von Material X in Lager Y gerade auf Lager".
    // daher nur hier die isWarnung Methode
    // Werte soll sie nur von BestandsbewegungDAO erhalten
